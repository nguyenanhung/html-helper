            ...
            if (isset($keyword) && !empty($keyword)) {
                ...
                for ($j = 0; $j <= count($arr_text_search) - 1; $j++) {
                    ...
                    if (stripos($str, strtolower($ki_tu_can_tim_convert)) > 0) {
                        ...
                        if (strpos("<span style='" . $font_color . "'>", $ki_tu_chuoi_can_xu_ly) === false || strpos("</span>", $ki_tu_chuoi_can_xu_ly) === false) {
                            $string = str_replace($ki_tu_chuoi_can_xu_ly, "<span style='" . $font_color . "'>" . $ki_tu_chuoi_can_xu_ly . "</span>", $string);
                        }
                    }
                }
            }
